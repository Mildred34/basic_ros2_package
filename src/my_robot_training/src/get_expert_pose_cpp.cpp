...
GetPose::GetPose():Node("get_expert_pose_node_cpp", rclcpp::NodeOptions().automatically_declare_parameters_from_overrides(true)), count_(0)
{
    ...
    auto move_group_interface = moveit::planning_interface::MoveGroupInterface(move_group_node, PLANNING_GROUP);
